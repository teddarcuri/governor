  ...
  <header id="hero" role="banner">
    <div class="hero">
      <div class="hero-inner">
        ...
        <div class="hero-copy">
          <h2>Welcome to <strong>Neato</strong>.</h2>
          <p>To get started, delete this example 'page--front.tpl.php' from the subtheme.</p>
        </div>
      </div>
    </div>
  </header>
